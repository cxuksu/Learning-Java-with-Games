...
public class Consts {
    ...
    public static final int V_BLACKJACK = 21;
    ...
    public static final int PLAYER_PANEL_H = 120;
    
    public static final int CARD_X = 120;
    ...
    public static final int CHIP_RANGE_X = 50;
    public static final int CHIP_MINX = 270;
    public static final int CHIP_RANGE_Y = 20;
    public static final int CHIP_MINY = 130;
    public static final int CHIPS_VALUE_X = 400;
    public static final int CHIPS_VALUE_Y = 160;
}
