/*
 * Consts.java -- A class defines constants.
 */
package analogclock;
...
public class Consts {
    ...
    public static final int CENTER_X = (MAXX - MINX) / 2;
    public static final int CENTER_Y = (MAXY - MINY) / 2;
    public static final int TICK_ANGLE = 6; // one second moves 360/60 degree
    public static final double MINUTE_ANGLE = 0.1; // one minute moves 6/60 degree
    public static final double HOUR_ANGLE = 0.008333; // one hour moves 30/3600 degree
