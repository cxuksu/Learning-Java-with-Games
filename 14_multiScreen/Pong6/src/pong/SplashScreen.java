...
public class SplashScreen extends JPanel implements ActionListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        String script2
                = "Whenever the game player bounced the ball with the paddle, "
                + "he/she gains a score; but if he/she loses the bouncing ball "
                + "and allows the ball hitting on the right edge of the playing "
                + "field, the game is terminated.";
