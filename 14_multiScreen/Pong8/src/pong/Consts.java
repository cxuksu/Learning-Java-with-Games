...
public class Consts {
    ...
    public static final int BALL_DX = 6;
    public static final int BALL_DY = 4;
    public static final int HOLE_WIDTH = 8;
    public static final int HOLE_HEIGHT = 30;
    
    public static final int MAX_BALL = 5;
