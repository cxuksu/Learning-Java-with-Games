...
public class Consts {
    ...
    public static final int WORM_UNIT_RADIUS = 5;
    public static final int TREAT_WIDTH = 14;
    public static final int TREAT_HEIGHT = 12;
    public static final int EAST = 1;
    public static final int WEST = 2;
    public static final int SOUTH = 3;
    public static final int NORTH = 4;
    
    public static final int EAT_TREAT = 0;
    public static final int GAME_OVER = 1;
    public static final int AUTO_EAT = 2; 
}
