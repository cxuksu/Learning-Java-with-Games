...
public class Consts {
    ...
    public static final int NEXTLINE = 30; // increase y by 50
    public static final int RECT_W = 10;
    public static final int RECT_H = 10;
    
    public static final int BRICK_W = 16;
