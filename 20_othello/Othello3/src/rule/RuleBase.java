/*
 * RuleBase.java - A class defines a rule base for instantiating all of
 * flipping rules and inserting them into the linear data structure
 */
package rule;
...
public class RuleBase {
    ...
    public void flipPiece() {
        for (int idx = 0; idx < rules.size(); idx++) {
            ...
            // set flipFlag true to measure and flip pieces
            aRule.setFlipFlag(true);
            aRule.isValid(newRow, newCol); // it meauses startRow-untilRow 
            aRule.flipPiece(); // it flips from startRow to untilRow
