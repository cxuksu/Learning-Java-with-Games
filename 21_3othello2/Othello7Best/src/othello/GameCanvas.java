...
public class GameCanvas extends AbsGameCanvas {
    ...
    public void initCompPlayer() {
        ...
        compPlayer.addPropertyChangeListener(new TermiGame());
    ...
    public void announceTermination(Graphics2D g2d) {
        ...
        g2d.drawString("Game Terminates", 50, Consts.MAXY / 2);
        g2d.setColor(Color.BLUE);
        g2d.drawString("No moer possible moves",
                40, Consts.MAXY / 2 + 30);
        ...
        public void propertyChange(PropertyChangeEvent evt) {
            ...
            if (checkRule.equals("checkRules")) {
                ...
                if (ruleBase.isRuleValid()) {
                    ...
                    cellBoard.setTotalNumFlip(ruleBase.getTotalNumFlip());
    ...
    class TermiGame implements PropertyChangeListener {
        @Override
        public void propertyChange(PropertyChangeEvent evt) {
            String pName = evt.getPropertyName();
            if (pName.equals("terminateGame")) {
                setGameOver(true);
            }
        }
    }
