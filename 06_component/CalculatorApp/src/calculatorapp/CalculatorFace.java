...
public class CalculatorFace extends JPanel {
    ...
    private void initComponents() {
        // the top board of the bottom portion
        JPanel ub = new JPanel(); // ub -- up board
    ...
    // initialize or re-initialize values for starting a new computation
    ...
    // an inner class implements the action listener
    class DigitActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent evt) {
            ...
            // equal sign trigers a computation
            ...
            } else if (obj.equals(bReset)) { // reset button re-initializes
                initReset();
            }
        }
