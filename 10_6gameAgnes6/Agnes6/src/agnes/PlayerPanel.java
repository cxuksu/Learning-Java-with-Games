/*
 * PlayerPanel.java - A class defines a player's panel for bottons of "New Game"
 * and "Quit".
 */
package agnes;
...
public class PlayerPanel extends JPanel {
    ...
    private void initPanel() {
        ...
        newGameBtn.addMouseListener(new MyMouseAdapter());
        newGameBtn.addActionListener(myActionListener);
        quitBtn.addMouseListener(new MyMouseAdapter());
